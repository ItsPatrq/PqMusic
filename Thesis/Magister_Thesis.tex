...
Wyniki ewaluacji algorytmów dla sygnałów polifonicznych znajdują się w tabeli \ref{tab:eval:poli}. Testy wykonane zostały z maksymalnym błędem równym 0.085s. na 2 kompozycjach z łącznie 4431 zdarzeniami MIDI i łącznym czasem odtwarzania 310s. Miary statystyczne są średnią miar wszystkich przypadków testowych, natomiast kolumna T reprezentuje średni czas wykonania algorytmu. Kolumny FN, FP i TP odpowiadają mocy zbiorów wszystkich sklasyfikowanych zdarzeń.
...
% \ref{sec:end} - dlatego że zakończenie nie jest numerowane, \ref na nim powoduje wstawienia się referencji do rozdziału wcześniej.
% Nie dodawałem żadnego opisu implementacji Onsets and Frames ponieważ duża część tego jest wzięta z ich jupiter notebooka. Czy to ok?
