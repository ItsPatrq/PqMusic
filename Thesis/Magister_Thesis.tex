...
\begin{table}[H]
  ...
  \begin{tabular}{ |c|c|c|c|c|c|c|c|c|c|c| } 
    ...
    \hline
    \end{tabular}
  \caption{$\mu$ - threashold amplitudy $W$ - scalanie nut, $P$ - odstęp pików $k$ - ważność gładkości, K - zakres temporal smoothing, M - pitch tracking combinations, $C$ - równoległe nuty, $\gamma$ - maksymalna różnica w głośnościach kombinacji }\label{tab:bestArgMono}
  \end{center}
\end{table}
...
\begin{table}[H]
  \begin{center}
    ...
    \hline
    algorytm & dokładność & precyzja & czułość & F1 & T\\
    \hline
    AC & 8192 & 512 & 8192 & 1 & 1  \\
    ACLOS & 8192 & 512 & 8192 & 1 & 1\\
    CEPS & 8192 & 512 & 8192 & 1 & 1\\
    P\&I 08 & 8192 & 512 & 8192 & 1 & 1\\
    P\&I 12 & 8192 & 512 & 8192 & 1& 1\\
    \hline
    \end{tabular}
  \end{center}
  \caption{Tu będą wyniki ewaluacji MONO soon. T - średni czas wykonywania}
  \label{tab:eval:mono}
\end{table}
...
\begin{table}[H]
  \begin{center}
      ...
      P\&I 08 & 8192 & 512 & 8192 & 1 & 1\\
      P\&I 12 & 8192 & 512 & 8192 & 1& 1\\
      Onsets and Frames & 8192 & 512 & 8192 & 1& 1 \\
      \hline
      \end{tabular}
  \end{center}
