...
Dalsze rozważania będą przebiegać z założeniem, że przetwarzane sygnały są z podzbioru muzyki o standardach kompozycji zachodniej muzyki, lecz bez wyszczególnionego gatunku muzycznego. Nie będziemy również skupiali się na wykryciu tak zwanych dźwięków bez wysokości, do których zaliczają się elementy perkusyjne. Ważnym założeniem, które będę stosować w tym rozdziale jest analiza jedynie sygnałów monofonicznych. W odróżnieniu do krzywych reprezentujących muzykę polifoniczną, w analizowanych utworach będzie grany tylko jeden dźwięk na instrumencie jednocześnie. Algorytmy analizujące muzykę wielotonową są opisane w rozdziale \ref{sec:MultiPitch}.

\subsubsection{Algorytmy operujące na domenie czasu}

\subsubsection{Algorytmy operujące na domenie częstotliwości}
