...
\clearpage
\section{Estymacja wielu częstotliwości fundamentalnej w sygnale polifonicznym}\label{sec:MultiPitch}
...
Śledzenia wysokości zaproponowane w pracy \cite[7-8]{Transcription:Pertus:Inharmonicity2} jest 
