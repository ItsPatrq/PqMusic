...
\begin{table}[ht]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Tu będą najlepsze argumenty mono}
  \label{tab:bestArgMono}
\end{table}
...
\begin{table}[ht]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Tu będą wyniki ewaluacji soon}
  \label{tab:ewaluation}
\end{table}
