...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Przykład funkcji okna czasowego dla okna audio zawierającej 2048 sampli}
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Przykład pojedyńczego komponentu spektralnego ze spektrogramu \ref{fig:windowSize} o długości okna 4096. W domenie częstotliwości piki pojawiają się periodycznie.} %%TODO:
...
\begin{figure}[h]
  \begin{center}
    ...
    \caption{Wykres przedstawiający spektrum na pojedyńczym oknie przed i po procesie lifterowania ze współczynnikiem równym 10} %TODO: dodanie skali
...
Wyniki ewaluacji algorytmów dla sygnałów polifonicznych znajdują się w tabeli \ref{tab:eval:poli}. Testy wykonane zostały na 10 kompozycjach z łącznie XXXX zdarzeniami MIDI i łącznym czasem odtwarzania XXXs. Miary statystyczne są średnią miar dla wszystkich przypadków testowych, natomiast kolumna T reprezentuje średni czas wykonania algorytmu.
...
\begin{table}[H]
  \begin{center}
    ...
    \hline
    AC & 0.326 & 0.380 & 0.515 & 0.425 & 3.957 \\
    ACLOS & 0.266 & 0.297 & 0.485 & 0.360 & 11.819\\
    CEPS & 0.279 & 0.309 & 0.647 & 0.400 & 0.417\\
    CEPS GPU & - & - & - & - & 1.968\\
    P\&I 08 & 0.337 & 0.430 & 0.484 & 0.443 & 4.308\\
    P\&I 12 & 0.225 & 0.308 & 0.367 & 0.320 & 5.536\\
    \hline
    \end{tabular}
  \end{center}
