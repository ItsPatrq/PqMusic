...
Cepstrum zostało dokładnie opisane w pracy \cite{Transcription:Bogert:FirstCepstrum}, a następnie w roku 1967 zastosowane do wykrywania wysokości dźwięku w \cite{Transcription:Noll:CepstrumPitchDetermination}. Jak opisuje Oppenheim i Schafer w historii cepstrum w \cite{Transcription:Oppenheim:HistoryOfCepstrum} równolegle z tymi pracami, niezależnie powstała praca naukowa \cite{Transcription:Oppenheim:Superposition} badająca klasę nielinearnych technik przetwarzania sygnałów poprzez koncepcje homomorficznego mapowania pomiędzy grupami algebraicznymi i przestrzeniami wektorowymi. Miała ona pokrywać się wnioskami z pracą na temat cepstrum, przyspieszając jego rozwój i skale zastosowań.
