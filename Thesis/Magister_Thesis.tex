...
Obowiązujący obecnie strój zakłada referencyjne mierzenie czestotliwości zależnie od wysokości A4, która powinna być równa 440 Hz. Każda oktawa zaczyna się od częstotliwości dwa razy większej od poprzedniej. Standard MIDI mapuje daną częstotliowość bazową na liczbę rzeczywistą odpowiadającą wysokości dźwięku przy pomocy wzoru:
...
Pomiędzy tymi stopniami są kroki pośrednie, odpowiednio mezzo-forte (dość głoścno) i mezzo-piano (dość cicho). Poza czterema wymienionymi przypadkami dostępne są równierz skrajności odpowiadające za bardzo gośny (odpowiednio - cichy) i możliwie najgłośniejszy (odpowiednio - najcichszy) odcień dynamiki. 
...
Barwa dźwięku (inaczej tembr) jest cechą odwołującą się harmonicznej domeny sygnału fonicznego.
